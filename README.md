...
This codebase was created to demonstrate a fully fledged fullstack application built with **Ruby on Rails** including CRUD operations, authentication, routing, pagination, and more.
